    ...
    <header className="sticky top-0 z-[100] grid items-center justify-between grid-cols-3 py-4 px-8 bg-white border-b-2 shadow-md">
      ...
      <div className="relative flex items-center justify-end h-10 space-x-4">
        <div className="flex items-center h-full space-x-2">
          <span className="px-3 py-2 overflow-hidden rounded-full cursor-pointer text-textDark hover:bg-gray-100">
            Become a host
          </span>
          <GlobeAltIcon className="h-full p-2 rounded-full cursor-pointer text-textDark hover:bg-gray-100" />
        </div>
